...
# Web UI: responsive runs (~2–8 min). Full quality: use CLI with higher limits.
WEB_TABU_ITERATIONS = 2000
WEB_TABU_NEIGHBORS_PER_ITERATION = 40
WEB_TABU_MAX_NO_IMPROVE = 80
WEB_TABU_LOG_EVERY = 25
WEB_SA_ITERATIONS = 400
